...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <div className="relative mx-auto h-[100dvh] w-full max-w-[480px] overflow-y-auto overflow-x-hidden overscroll-none bg-background sm:border-x sm:border-border/60 sm:shadow-[0_0_80px_rgba(10,10,10,0.08)]">
        <Outlet />
      </div>
